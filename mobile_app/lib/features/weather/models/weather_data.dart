...
class DetailedWeatherData {
  final double temp;
  final double? feelsLike; // nullable: backend may not provide
  final String condition;
  final double precipitation; // probability 0-100
  final double windSpeed; // m/s
  final int humidity; // %
  final double uvIndex;
  final double? visibility; // nullable: backend may not provide
  final double? pm25;
  final double? pm10;
  final double? o3;
  final double? no2;
  ...
  factory DetailedWeatherData.fromJson(Map<String, dynamic> json) {
    return DetailedWeatherData(
      ...
      condition: json['weather_text'] as String? ?? json['condition'] as String? ?? '',
      precipitation: (json['precipitation_probability'] as num?)?.toDouble()
      ...
      pm25: (json['pm2_5'] as num?)?.toDouble() ?? (json['pm25'] as num?)?.toDouble(),
